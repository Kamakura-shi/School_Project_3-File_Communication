 ...
 *
 * Permet d'ajouter l'état de l'évaluation à la structure critere
 *
 * critere : la structure à modifier
 * a_evalue : l'état de l'évaluation à ajouter
 */
void set_a_evalue(t_critere critere, char* a_evalue);
 ...
 * critere : la structure à observer
 *
 * Retour : indicateur constituant l'état de l'évaluation de la
 *          structure donnée en paramètre
 */
